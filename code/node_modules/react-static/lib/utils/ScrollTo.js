...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ease, 'ease', 'src/utils/ScrollTo.js');

  __REACT_HOT_LOADER__.register(defaultOptions, 'defaultOptions', 'src/utils/ScrollTo.js');

  __REACT_HOT_LOADER__.register(getTop, 'getTop', 'src/utils/ScrollTo.js');

  __REACT_HOT_LOADER__.register(getPosition, 'getPosition', 'src/utils/ScrollTo.js');

  __REACT_HOT_LOADER__.register(scrollTo, 'scrollTo', 'src/utils/ScrollTo.js');
}();
